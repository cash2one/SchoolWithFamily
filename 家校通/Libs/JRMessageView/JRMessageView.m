...
- (instancetype)initWithTitle:(NSString *)title
	...
	if (self = [self init]) {
		...
		if (self.type == JRMessageViewTypeSuccess) {
			...
			self.backgroundColor = [UIColor colorWithRed:68/255.f green:206/255.f blue:98/255.f alpha:1.0];
		} else if (self.type == JRMessageViewTypeError) {
			self.backgroundColor = [UIColor colorWithRed:228/255.f green:80/255.f blue:52/255.f alpha:1.0];
