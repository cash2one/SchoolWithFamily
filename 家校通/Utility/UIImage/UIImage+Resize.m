...
- (CGSize)shrinkFromImageSize:(CGSize)targetSize
{
...
//    CGPoint scaledPoint = CGPointZero;
    ...
    CGFloat xyFactor = width / height;
    CGFloat tXYFactor = targetWidth / targetHeight;
    
    if (tXYFactor != xyFactor)
    {
...
//        if (widthFactor > heightFactor)
//        {
//            scaledPoint.x = (scaledWidth - targetWidth) / 2.0 * heightFactor;
//            scaledWidth = width / widthFactor * heightFactor;
//            scaledHeight = height;
//        }
//        else
//        {
//            scaledPoint.y = (scaledHeight - targetHeight) / 2.0 * widthFactor;
//            scaledHeight = height / heightFactor * widthFactor;
//            scaledWidth = width;
//        }
//        targetRect = CGRectMake(scaledPoint.x, scaledPoint.y, scaledWidth, scaledHeight);
    }
...
+ (UIImage *)thumbnailOfImage:(UIImage *)aImage Size:(CGSize)newSize
{
    ...
    {
        imageCopy = [aImage fixOrientation];
    }
    ...
    float x_ = width / (newSize.width);
    float y_ = height / (newSize.height);
    float scale = MAX(x_, y_);
